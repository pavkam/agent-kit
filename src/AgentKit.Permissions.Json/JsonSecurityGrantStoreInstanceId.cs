...
/// <summary>Identifies the exact initialized JSON grant-store root expected by host bootstrap configuration.</summary>
/// <remarks>
...
/// serving another deployment's authority evidence.
/// </remarks>
public readonly record struct JsonSecurityGrantStoreInstanceId
{
    ...
    public JsonSecurityGrantStoreInstanceId(Guid value)
    {
