...
/// <summary>Owns bounded measurements emitted by the JSON security-grant adapter.</summary>
internal static class JsonSecurityGrantStoreMetrics
{
    ...
    internal static Counter<long> Operations { get; } = AgentKitDiagnostics.Metrics.CreateCounter<long>(
        ...
        unit: "{operation}",
        description: "Number of terminal JSON security-grant store operations.");
    ...
    internal static Histogram<double> Duration { get; } = AgentKitDiagnostics.Metrics.CreateHistogram<double>(
        ...
        unit: "s",
        description: "Duration of authoritative JSON security-grant store operations.");
}
