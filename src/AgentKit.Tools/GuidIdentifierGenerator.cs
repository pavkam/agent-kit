...
/// <c>AddToolCatalogCoordinator</c>. Applications and tests register a
/// deterministic <see cref="IIdentifierGenerator{TIdentifier}"/> in its place
/// when reproducible identities are required.
/// </remarks>
