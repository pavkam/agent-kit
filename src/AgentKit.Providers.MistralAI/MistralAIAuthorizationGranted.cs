...
/// </summary>
/// <remarks>
/// Mistral AI has exactly one authentication mechanism: a bearer token sent
/// as <c>Authorization: Bearer &lt;value&gt;</c>. Both a static API key and
/// an OAuth access token are sent through the identical header shape, so
...
/// <see cref="MistralAIAuthorizationHeaderFactory"/> selected and whether it
/// checked an expiry.
/// </remarks>
public sealed record MistralAIAuthorizationGranted: MistralAIAuthorizationResult
{
    /// <summary>Initializes a new instance of the <see cref="MistralAIAuthorizationGranted"/> record.</summary>
    ...
    /// </exception>
    public MistralAIAuthorizationGranted(string headerName, string headerValue)
    {
