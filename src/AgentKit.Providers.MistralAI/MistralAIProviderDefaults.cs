...
/// </summary>
/// <remarks>
/// This package covers only <c>POST /v1/chat/completions</c> (buffered and
/// streaming) for text and client-executed function tools. Fill-in-the-middle,
/// Conversations/Agents, embeddings, moderation, classification, OCR, audio,
/// files, libraries, batch, and fine-tuning are separate contracts not
/// covered by this package. Hosted tools (web search, code interpreter,
/// image generation, document library, custom connectors) and the
/// <c>response_format</c> structured-output control are not yet translated.
/// </remarks>
