...
/// <see cref="IMistralAIResponseParser"/> needs to translate one raw
/// Mistral AI Chat Completions HTTP response body into a
...
/// </remarks>
public sealed record MistralAIResponseParseContext
{
    /// <summary>Initializes a new instance of the <see cref="MistralAIResponseParseContext"/> record.</summary>
    ...
    /// </param>
    public MistralAIResponseParseContext(
