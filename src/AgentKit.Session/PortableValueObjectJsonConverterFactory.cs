...
internal sealed class PortableValueObjectJsonConverterFactory: JsonConverterFactory
{
    /// <inheritdoc/>
    ...
    public override JsonConverter CreateConverter(Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return (JsonConverter) Activator.CreateInstance(
            typeof(PortableValueObjectJsonConverter<>).MakeGenericType(typeToConvert))!;
    }
}
