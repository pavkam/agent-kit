...
/// <summary>Provides canonical package-local argument guards for explicit session-store composition.</summary>
/// <remarks>The guards keep descriptor capture validation and duplicate-key validation consistent across the catalog and selector. They are called through <see cref="ArgumentException"/> so composition failures retain an exact caller argument name.</remarks>
