...
/// <summary>Validates the receipt required before a scripted process start becomes observable.</summary>
/// <remarks>The receipt proves permission to start one fresh scenario and does not prove that the scenario has settled.</remarks>
internal static class ProcessEnforcementReceipt
{
    ...
    /// <summary>Determines whether a consumption result authorizes this new exact scripted process-start effect.</summary>
