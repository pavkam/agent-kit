...
/// <summary>Validates the permission-to-start receipt required before a network effect begins.</summary>
/// <remarks>A receipt proves only that the grant store authorized this fresh attempt; it never proves DNS or egress completed.</remarks>
internal static class NetworkEnforcementReceipt
{
    ...
    /// <summary>Determines whether a consumption result authorizes this new exact network effect.</summary>
