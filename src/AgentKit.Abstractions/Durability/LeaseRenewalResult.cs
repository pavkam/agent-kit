...
/// <summary>
/// The immutable base for the terminal outcome of one lease renewal attempt.
/// </summary>
/// <remarks>
/// This is a closed discriminated hierarchy. The concrete kinds are
/// <see cref="LeaseRenewed"/> and <see cref="LeaseLost"/>. Its constructor is
/// <see langword="private protected"/>, so no assembly outside
/// AgentKit.Abstractions can add a third kind.
/// </remarks>
public abstract record LeaseRenewalResult
{
    /// <summary>
    /// Initializes a new instance of the <see cref="LeaseRenewalResult"/>
    ...
    /// hierarchy.
    /// </summary>
    private protected LeaseRenewalResult()
    {
    }
}
