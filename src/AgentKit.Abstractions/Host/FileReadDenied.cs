...
/// or otherwise fails the low-level implementation's own boundary
/// enforcement.
/// </summary>
/// <remarks>
...
/// </remarks>
public sealed record FileReadDenied: FileReadResult
{
    /// <summary>Initializes a new instance of the <see cref="FileReadDenied"/> record.</summary>
    ...
    /// whitespace.
    /// </exception>
    public FileReadDenied(string safeMessage)
    {
