...
/// <summary>
/// A validated non-empty semantic key selecting one registered file-system
/// profile and its capability set.
/// </summary>
/// <remarks>
/// This type is an immutable value object with structural (ordinal, textual)
/// equality over <see cref="Value"/>.
/// </remarks>
public readonly record struct FileSystemProfileKey
{
    /// <summary>
    /// Initializes a new instance of the <see cref="FileSystemProfileKey"/>
    ...
    /// </exception>
    public FileSystemProfileKey(string value)
    {
