...
/// </remarks>
[Obsolete("Use IFileReader with the spec FileReadRequest and AuthorizedFileRead instead.")]
public sealed record LegacyFileReadRequest
{
    /// <summary>Initializes a new instance of the <see cref="LegacyFileReadRequest"/> record.</summary>
    ...
    public LegacyFileReadRequest(FileSystemPath path, SecurityGrant grant)
    {
