...
/// <summary>Identifies one network resolution or request operation.</summary>
/// <remarks>
/// <para>
...
/// so a valid <see cref="NetworkOperationId"/> always addresses a real
/// operation.
/// </para>
/// </remarks>
public readonly record struct NetworkOperationId
{
    /// <summary>
    /// Initializes a new instance of the <see cref="NetworkOperationId"/>
    /// struct, validating that it addresses a real operation rather than an
    /// empty placeholder.
    /// </summary>
    ...
    /// </exception>
    public NetworkOperationId(Guid value)
    {
