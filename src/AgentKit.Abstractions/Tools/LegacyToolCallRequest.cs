...
/// </remarks>
public sealed record LegacyToolCallRequest
{
    /// <summary>Initializes a new instance of the <see cref="LegacyToolCallRequest"/> record.</summary>
    ...
    public LegacyToolCallRequest(ToolReference tool, ToolExecutionContext context, JsonElement arguments, DateTimeOffset requestedAt)
    {
