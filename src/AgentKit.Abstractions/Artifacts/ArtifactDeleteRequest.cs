...
public sealed record ArtifactDeleteRequest
{
    ...
    public ArtifactDeleteRequest(AgentId agentId, SessionId? sessionId, ToolCallId? toolCallId, OperationCorrelation correlation, ExecutionIdentity identity, ArtifactReference reference, IdempotencyKey idempotencyKey)
    {
