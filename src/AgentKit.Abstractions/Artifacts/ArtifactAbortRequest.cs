...
public sealed record ArtifactAbortRequest
{
    ...
    public ArtifactAbortRequest(ArtifactPreparationId preparationId, AgentId agentId, SessionId? sessionId, OperationCorrelation correlation, ExecutionIdentity identity, ArtifactAbortReason reason, IdempotencyKey idempotencyKey)
    {
        ...
        Identity = identity; Reason = reason; IdempotencyKey = idempotencyKey;
    }
