...
/// Valid instances are restricted to those built-in variants. The
/// parameterless constructor cannot be used outside this assembly, and the
/// guarded record-copy constructor prevents an external derived record from
...
public abstract record BudgetBatchReservationResult
{
    ...
    /// result.
    /// </remarks>
    protected BudgetBatchReservationResult(BudgetBatchReservationResult original)
    {
