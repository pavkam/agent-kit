...
/// <summary>
/// Identifies one hierarchical budget scope: a host, tenant, principal,
/// agent, session, run, or operation address inside the shared budget
/// ledger.
/// </summary>
/// <remarks>
/// <para>
...
/// so a valid <see cref="BudgetScopeId"/> always addresses a real scope.
/// </para>
/// </remarks>
public readonly record struct BudgetScopeId
{
    /// <summary>
    /// Initializes a new instance of the <see cref="BudgetScopeId"/>
    /// struct, validating that it addresses a real scope rather than an
    /// empty placeholder.
    /// </summary>
    ...
    /// address a real scope.
    /// </exception>
    public BudgetScopeId(Guid value)
    {
