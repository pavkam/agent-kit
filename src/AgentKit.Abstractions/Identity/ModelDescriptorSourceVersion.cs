...
/// <summary>
/// The revision of one descriptor source's contributed content, used to
...
/// </para>
/// <para>
/// Source versions are independent of <see cref="ModelCatalogVersion"/>. A
/// catalog version changes when the composed snapshot is republished; a
/// source version changes only when that one contributor's own content
/// changes.
/// </para>
/// </remarks>
public readonly record struct ModelDescriptorSourceVersion
{
    /// <summary>
    /// Initializes a new instance of the
    /// <see cref="ModelDescriptorSourceVersion"/> struct, validating that it
    ...
    /// </exception>
    public ModelDescriptorSourceVersion(long value)
    {
