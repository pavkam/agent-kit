...
/// <summary>Selects one named security authority and policy profile for an agent definition.</summary>
/// <remarks>This immutable value uses ordinal text equality. Naming a profile never authenticates identity, grants authority, or authorizes an effect. Values are preserved exactly without trimming or normalization and compare with ordinal, case-sensitive semantics. A default instance has no usable selection text; consumers must reject it at their boundary.</remarks>
public readonly record struct SecurityProfileKey
{
    /// <summary>Initializes a validated security-profile selection key.</summary>
    ...
    public SecurityProfileKey(string value)
    {
