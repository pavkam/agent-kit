...
/// <summary>Identifies one provider model revision with exact nonblank ordinal text.</summary>
...
public readonly record struct ProviderModelRevision
{
    ...
    public ProviderModelRevision(string value)
    {
