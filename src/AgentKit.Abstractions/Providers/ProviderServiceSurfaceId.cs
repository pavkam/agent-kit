...
/// <summary>Identifies one provider service surface with exact nonblank ordinal text.</summary>
...
public readonly record struct ProviderServiceSurfaceId
{
    ...
    public ProviderServiceSurfaceId(string value)
    {
