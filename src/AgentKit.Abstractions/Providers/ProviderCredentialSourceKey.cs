...
/// <summary>Identifies one provider credential source with exact nonblank ordinal text.</summary>
...
public readonly record struct ProviderCredentialSourceKey
{
    ...
    public ProviderCredentialSourceKey(string value)
    {
