...
/// <summary>Identifies one provider API revision with exact nonblank ordinal text.</summary>
...
public readonly record struct ProviderApiVersion
{
    ...
    public ProviderApiVersion(string value)
    {
