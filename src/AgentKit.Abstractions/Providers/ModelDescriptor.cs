...
/// <summary>
/// Describes one configured, selectable model: its identity, capabilities,
/// limits, and optional pricing, independent of the application-facing
/// <see cref="ModelAlias"/> used to select it.
/// </summary>
/// <remarks>
/// <para>
...
/// identity tuple: capabilities and behavior belong to that exact
/// combination, not to a brand name alone. Wire-level compatibility
/// behavior (roles, tool-choice shape, streaming event framing) is
/// configured directly on the concrete adapter rather than stored on this
/// descriptor, so the same descriptor shape can describe models served by
/// entirely different wire protocols.
/// </para>
/// </remarks>
public sealed record ModelDescriptor
{
    /// <summary>Initializes a new instance of the <see cref="ModelDescriptor"/> record.</summary>
    ...
    /// <param name="limits">The token limits of this model.</param>
    ...
    /// <summary>Gets the token limits of this model.</summary>
