...
/// reuse the same <see cref="LlmRequestContext.ModelRequestId"/> across
...
{
    /// <summary>Initializes a new instance of the <see cref="LlmModelRequest"/> record.</summary>
    ...
    /// <summary>Gets the one-based attempt number for this request's <see cref="LlmRequestContext.ModelRequestId"/>.</summary>
    /// <exception cref="ArgumentOutOfRangeException">
