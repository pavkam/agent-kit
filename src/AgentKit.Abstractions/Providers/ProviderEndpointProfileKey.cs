...
/// <summary>Identifies one provider endpoint profile with exact nonblank ordinal text.</summary>
...
public readonly record struct ProviderEndpointProfileKey
{
    ...
    public ProviderEndpointProfileKey(string value)
    {
