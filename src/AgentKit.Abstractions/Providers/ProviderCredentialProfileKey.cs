...
/// <summary>Identifies one provider credential profile with exact nonblank ordinal text.</summary>
...
public readonly record struct ProviderCredentialProfileKey
{
    ...
    public ProviderCredentialProfileKey(string value)
    {
