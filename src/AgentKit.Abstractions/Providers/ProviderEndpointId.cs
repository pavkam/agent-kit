...
/// <summary>Identifies one configured provider endpoint with exact nonblank ordinal text.</summary>
...
public readonly record struct ProviderEndpointId
{
    ...
    public ProviderEndpointId(string value)
    {
