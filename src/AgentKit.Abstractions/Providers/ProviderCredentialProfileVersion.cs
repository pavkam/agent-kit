...
/// <summary>Identifies one positive immutable credential-profile publication revision.</summary>
...
public readonly record struct ProviderCredentialProfileVersion
{
    ...
    public ProviderCredentialProfileVersion(long value)
    {
