...
/// <see cref="SessionBranchRequest"/>.
/// </summary>
/// <remarks>
/// This is a closed discriminated hierarchy. The concrete kinds are
/// <see cref="SessionBranched"/>, <see cref="SessionBranchParentNotFound"/>,
/// and <see cref="SessionBranchFailed"/>. Its constructor is
/// <see langword="private protected"/>, so no assembly outside
/// AgentKit.Abstractions can add a fourth kind.
/// </remarks>
public abstract record SessionBranchResult
{
    /// <summary>
    /// Initializes a new instance of the <see cref="SessionBranchResult"/>
    ...
    /// the hierarchy.
    /// </summary>
    private protected SessionBranchResult()
    {
    }
}
