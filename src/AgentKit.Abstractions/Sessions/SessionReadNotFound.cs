...
/// </summary>
public sealed record SessionReadNotFound: SessionPageResult
{
    /// <summary>Initializes a new instance of the <see cref="SessionReadNotFound"/> record.</summary>
    /// <param name="address">The requested session address.</param>
    /// <exception cref="ArgumentNullException"><paramref name="address"/> is null.</exception>
    public SessionReadNotFound(SessionAddress address)
    {
