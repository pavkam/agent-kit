...
/// <see cref="SessionCreateRequest"/>.
/// </summary>
/// <remarks>
/// This is a closed discriminated hierarchy. The concrete kinds are
/// <see cref="SessionCreated"/> and <see cref="SessionCreateFailed"/>. Its
/// constructor is <see langword="private protected"/>, so no assembly
/// outside AgentKit.Abstractions can add a third kind.
/// </remarks>
public abstract record SessionCreateResult
{
    /// <summary>
    /// Initializes a new instance of the <see cref="SessionCreateResult"/>
    ...
    /// the hierarchy.
    /// </summary>
    private protected SessionCreateResult()
    {
    }
}
