# AgentKit.Providers.AzureOpenAI

Connect AgentKit conversational models to Azure OpenAI through GA v1 Chat
Completions.

Use this adapter when your application selects Azure OpenAI. Configure the
endpoint, credential source, model identity, and capability profile explicitly.
Embedding models have a separate registration.

## Use this project

Start with `AddAzureOpenAI`, `AddAzureOpenAILlmModel`,
`AddAzureOpenAIEmbeddingModel` in [ServiceExtensions.cs](ServiceExtensions.cs).
...
- [AgentKit.Providers.AzureOpenAI.Tests](../../tests/AgentKit.Providers.AzureOpenAI.Tests/README.md)
