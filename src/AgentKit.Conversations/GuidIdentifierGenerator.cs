...
/// <c>AddConversationSession</c> for the turn-scoped identities a conversation
/// session allocates. Applications and tests register a deterministic
/// <see cref="IIdentifierGenerator{TIdentifier}"/> in its place when
/// reproducible identities are required.
/// </remarks>
