...
/// <summary>Identifies the exact initialized SQLite decision-store target expected by host bootstrap configuration.</summary>
public readonly record struct SqliteSecurityDecisionStoreInstanceId
{
    ...
    public SqliteSecurityDecisionStoreInstanceId(Guid value)
    {
