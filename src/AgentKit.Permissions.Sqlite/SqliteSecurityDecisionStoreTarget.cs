...
/// </remarks>
public sealed record SqliteSecurityDecisionStoreTarget
{
    ...
    public SqliteSecurityDecisionStoreTarget(
        string databasePath,
        SqliteSecurityDecisionStoreInstanceId expectedStoreInstanceId,
    ...
    /// <value>The exact nondefault identity verified before every decision-store access.</value>
    public SqliteSecurityDecisionStoreInstanceId ExpectedStoreInstanceId { get; }
