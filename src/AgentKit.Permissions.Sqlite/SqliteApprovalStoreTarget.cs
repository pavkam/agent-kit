...
/// <summary>Captures one fixed local SQLite target supplied through the approval control-plane bootstrap boundary.</summary>
/// <remarks>
...
/// </remarks>
public sealed record SqliteApprovalStoreTarget
{
    ...
    public SqliteApprovalStoreTarget(
        string databasePath,
        SqliteApprovalStoreInstanceId expectedStoreInstanceId,
    ...
    /// <value>The exact nondefault identity verified before every approval-store access.</value>
    public SqliteApprovalStoreInstanceId ExpectedStoreInstanceId { get; }
