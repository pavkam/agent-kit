...
/// <summary>Identifies the exact initialized SQLite grant-store target expected by host bootstrap configuration.</summary>
public readonly record struct SqliteSecurityGrantStoreInstanceId
{
    ...
    public SqliteSecurityGrantStoreInstanceId(Guid value)
    {
