...
/// </remarks>
public sealed record SqliteSecurityGrantStoreTarget
{
    ...
    public SqliteSecurityGrantStoreTarget(
        string databasePath,
        SqliteSecurityGrantStoreInstanceId expectedStoreInstanceId,
    ...
    /// <value>The exact nondefault identity verified before every grant-store access.</value>
    public SqliteSecurityGrantStoreInstanceId ExpectedStoreInstanceId { get; }
