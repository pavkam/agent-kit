...
/// <summary>
/// Parses a raw Gemini GenerateContent HTTP response body into the ordered
...
/// </remarks>
public interface IGoogleGeminiResponseParser
{
    /// <summary>
    /// Parses a single, complete, buffered JSON response body returned by
    /// <c>:generateContent</c>.
    /// </summary>
    ...
    /// <summary>
    /// Parses a server-sent-events response body returned by
    /// <c>:streamGenerateContent?alt=sse</c>, delivering incremental events
    /// as each repeated partial <c>GenerateContentResponse</c> chunk
    /// arrives.
    /// </summary>
