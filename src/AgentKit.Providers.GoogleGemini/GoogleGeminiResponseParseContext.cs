...
/// <see cref="IGoogleGeminiResponseParser"/> needs to translate one raw
/// Gemini GenerateContent HTTP response body into a
...
/// </remarks>
public sealed record GoogleGeminiResponseParseContext
{
    /// <summary>Initializes a new instance of the <see cref="GoogleGeminiResponseParseContext"/> record.</summary>
    ...
    /// The provider-supplied request correlation identifier, when the
    /// provider supplied one.
    /// </param>
    public GoogleGeminiResponseParseContext(
