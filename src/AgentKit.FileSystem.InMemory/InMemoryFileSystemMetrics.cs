...
/// <summary>Records bounded in-memory file-system outcomes without paths, payloads, or security identities.</summary>
internal static class InMemoryFileSystemMetrics
{
