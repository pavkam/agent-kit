...
Fetch web content through bounded network operations and content projection.

Use this tool when an agent needs an authorized URL's content. Configure the
network boundary and policy; web search is a separate provider-backed tool.

## Use this project

Start with `AddWebFetchTool` in [ServiceExtensions.cs](ServiceExtensions.cs).
...
- [AgentKit.Tools.WebSearch](../AgentKit.Tools.WebSearch/README.md) — search the
  web through an explicitly configured search provider.
...
- [AgentKit.Tools.Web.Tests](../../tests/AgentKit.Tools.Web.Tests/README.md) —
