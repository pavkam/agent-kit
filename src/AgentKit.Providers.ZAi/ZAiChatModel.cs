...
/// <summary>
/// The Z.ai conversational <see cref="IChatModel"/>, built entirely from the
/// shared <see cref="OpenAICompatibleChatModelBase"/> pipeline.
/// </summary>
public sealed class ZAiChatModel: OpenAICompatibleChatModelBase
{
    /// <summary>Initializes a new instance of the <see cref="ZAiChatModel"/> class.</summary>
