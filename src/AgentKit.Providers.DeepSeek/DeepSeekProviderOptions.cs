...
/// <summary>
/// Configures the DeepSeek integration's endpoint and wire-behavior
/// defaults.
/// </summary>
/// <remarks>
...
/// <c>AddDeepSeekApiKeyCredential</c> or <c>AddDeepSeekOAuthCredential</c>,
...
{
    /// <summary>Gets or sets the base address of the DeepSeek REST API.</summary>
    public Uri BaseAddress { get; set; } = DeepSeekProviderDefaults.DefaultBaseAddress;

    /// <summary>Gets or sets the chat completions operation path, relative to <see cref="BaseAddress"/>.</summary>
    public string ChatCompletionsPath { get; set; } = DeepSeekProviderDefaults.DefaultChatCompletionsPath;
    ...
    /// <summary>
    /// Gets or sets whether a streaming request should ask DeepSeek to
