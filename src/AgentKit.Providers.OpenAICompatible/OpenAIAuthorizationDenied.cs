...
/// sending an authorization header known in advance to be rejected.
/// </remarks>
public sealed record OpenAIAuthorizationDenied: OpenAIAuthorizationResult
{
    /// <summary>Initializes a new instance of the <see cref="OpenAIAuthorizationDenied"/> record.</summary>
    /// <param name="failure">
    /// The normalized failure, whose <see cref="ProviderFailure.Kind"/> is
    /// <see cref="ProviderFailureKind.Authentication"/>.
    /// </param>
    /// <exception cref="ArgumentNullException"><paramref name="failure"/> is null.</exception>
    public OpenAIAuthorizationDenied(ProviderFailure failure)
    {
