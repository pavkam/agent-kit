...
Connect AgentKit conversational models to xAI through its OpenAI-compatible chat
surface.

Use this adapter when your application selects xAI. Configure the endpoint,
credential source, model identity, and capability profile explicitly. Embedding
models have a separate registration.

## Use this project

Start with `AddXAI`, `AddXAILlmModel`, `AddXAIEmbeddingModel` in
...
- [AgentKit.Providers.XAI.Tests](../../tests/AgentKit.Providers.XAI.Tests/README.md)
  — focused behavior and registration tests.
- [Component specification](../../docs/architecture/model-and-embedding-providers.md)
  — intended ownership and contracts.
- [xAI API reference](../../docs/providers/xai.md) — wire behavior and
