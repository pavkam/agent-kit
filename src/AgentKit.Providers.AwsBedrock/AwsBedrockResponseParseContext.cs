...
/// <see cref="IAwsBedrockResponseParser"/> needs to translate one raw
/// Bedrock Converse HTTP response body into a
...
/// </remarks>
public sealed record AwsBedrockResponseParseContext
{
    /// <summary>Initializes a new instance of the <see cref="AwsBedrockResponseParseContext"/> record.</summary>
    ...
    /// <c>x-amzn-RequestId</c> HTTP response header, when the provider
    /// supplied one.
    /// </param>
    public AwsBedrockResponseParseContext(
    ...
    /// the <c>x-amzn-RequestId</c> HTTP response header, when the provider
    /// supplied one.
    /// </summary>
