# AgentKit.Providers.AwsBedrock

Connect AgentKit conversational models to Amazon Bedrock through Converse and
ConverseStream.

Use this adapter when your application selects Amazon Bedrock. Configure the
...
- [AgentKit.Providers.AwsBedrock.Tests](../../tests/AgentKit.Providers.AwsBedrock.Tests/README.md)
