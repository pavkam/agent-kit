# AgentKit.Providers.GoogleVertexAI

Connect AgentKit conversational models to Google Vertex AI through its
generateContent surface.

Use this adapter when your application selects Google Vertex AI. Configure the
endpoint, credential source, model identity, and capability profile explicitly.
Embedding models have a separate registration.

## Use this project

Start with `AddGoogleVertexAI`, `AddGoogleVertexAILlmModel`,
`AddGoogleVertexAIEmbeddingModel` in
...
[AgentKit.Providers.GoogleGemini](../AgentKit.Providers.GoogleGemini/README.md).
Other related projects above are composition collaborators, not necessarily
dependencies.

## Tests and reference

- [AgentKit.Providers.GoogleVertexAI.Tests](../../tests/AgentKit.Providers.GoogleVertexAI.Tests/README.md)
  — focused behavior and registration tests.
- [Component specification](../../docs/architecture/model-and-embedding-providers.md)
  — intended ownership and contracts.
- [Google Vertex AI API reference](../../docs/providers/google-vertex-ai.md) —
  wire behavior and capability requirements.
