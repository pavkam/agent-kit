...
/// <c>AddAgentBudgets</c> for <see cref="BudgetScopeId"/> and
/// <see cref="BudgetReservationId"/> generation. Applications and tests
/// register a deterministic <see cref="IIdentifierGenerator{TIdentifier}"/>
/// in its place when reproducible identities are required.
/// </remarks>
