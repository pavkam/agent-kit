...
/// <summary>
/// The OpenRouter conversational <see cref="IChatModel"/>, built entirely
/// from the shared <see cref="OpenAICompatibleChatModelBase"/> pipeline.
/// </summary>
public sealed class OpenRouterChatModel: OpenAICompatibleChatModelBase
{
    /// <summary>Initializes a new instance of the <see cref="OpenRouterChatModel"/> class.</summary>
