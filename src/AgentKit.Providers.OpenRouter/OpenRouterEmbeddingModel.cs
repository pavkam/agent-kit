...
/// <summary>
/// The OpenRouter embedding <see cref="IEmbeddingModel"/>, built entirely
/// from the shared <see cref="OpenAICompatibleEmbeddingModelBase"/>
/// pipeline.
/// </summary>
public sealed class OpenRouterEmbeddingModel: OpenAICompatibleEmbeddingModelBase
{
    /// <summary>Initializes a new instance of the <see cref="OpenRouterEmbeddingModel"/> class.</summary>
    /// <param name="descriptor">The descriptor of the OpenRouter-routed embedding model this instance serves.</param>
