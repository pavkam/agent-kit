...
Use this adapter when your application selects OpenRouter. Configure the
endpoint, credential source, model identity, and capability profile explicitly.
Embedding models have a separate registration.

## Use this project

Start with `AddOpenRouter`, `AddOpenRouterLlmModel`,
`AddOpenRouterEmbeddingModel` in [ServiceExtensions.cs](ServiceExtensions.cs).
...
- [AgentKit.Providers.OpenRouter.Tests](../../tests/AgentKit.Providers.OpenRouter.Tests/README.md)
  — focused behavior and registration tests.
- [Component specification](../../docs/architecture/model-and-embedding-providers.md)
  — intended ownership and contracts.
- [OpenRouter API reference](../../docs/providers/openrouter.md) — wire behavior
