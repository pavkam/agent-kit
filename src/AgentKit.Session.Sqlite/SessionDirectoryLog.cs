...
internal static partial class SessionDirectoryLog
{
    ...
    [LoggerMessage(25002, LogLevel.Debug, "SQLite session directory operation {Operation} for agent {AgentId} and session {SessionId} completed with outcome {Outcome}.")]
    ...
    [LoggerMessage(25003, LogLevel.Error, "SQLite session directory operation {Operation} for agent {AgentId} and session {SessionId} failed with error type {ErrorType}.")]
