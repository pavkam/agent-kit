...
/// <summary>
/// Retains stable request evidence and the terminal result for one accepted durable operation.
/// </summary>
...
/// <remarks>
/// The containing store retains receipts only for its process lifetime. The request captures operation
/// target, tenant-scoped identity, concurrency version, payload, and extensions, while caller
    ...
    where TResult : class
{
    ...
    public IdempotencyReceipt(TRequest request, TResult result)
    {
