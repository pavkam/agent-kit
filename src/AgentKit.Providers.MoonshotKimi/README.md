# AgentKit.Providers.MoonshotKimi

Connect AgentKit conversational models to Moonshot Kimi through its
OpenAI-compatible chat surface.

Use this adapter when your application selects Moonshot Kimi. Configure the
...
Start with `AddMoonshotKimi`, `AddMoonshotKimiLlmModel` in
...
- [AgentKit.Providers.MoonshotKimi.Tests](../../tests/AgentKit.Providers.MoonshotKimi.Tests/README.md)
  — focused behavior and registration tests.
- [Component specification](../../docs/architecture/model-and-embedding-providers.md)
  — intended ownership and contracts.
- [Moonshot Kimi API reference](../../docs/providers/moonshot-kimi.md) — wire
