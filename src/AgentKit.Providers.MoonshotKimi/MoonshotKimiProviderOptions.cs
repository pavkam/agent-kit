...
/// <summary>
/// Configures the Moonshot Kimi integration's endpoint and wire-behavior
/// defaults.
/// </summary>
/// <remarks>
...
/// <c>AddMoonshotKimiApiKeyCredential</c> or <c>AddMoonshotKimiOAuthCredential</c>, because
/// credential material is never appropriate to bind from ordinary
/// configuration alongside endpoint options.
/// </remarks>
public sealed class MoonshotKimiProviderOptions
{
    /// <summary>Gets or sets the base address of the Moonshot Kimi REST API.</summary>
    public Uri BaseAddress { get; set; } = MoonshotKimiProviderDefaults.DefaultBaseAddress;

    /// <summary>Gets or sets the chat completions operation path, relative to <see cref="BaseAddress"/>.</summary>
    public string ChatCompletionsPath { get; set; } = MoonshotKimiProviderDefaults.DefaultChatCompletionsPath;
    ...
    /// <summary>
    /// Gets or sets whether a streaming request should ask Moonshot Kimi to
