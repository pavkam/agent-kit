...
/// <summary>
/// The Moonshot Kimi conversational <see cref="IChatModel"/>, built entirely
/// from the shared <see cref="OpenAICompatibleChatModelBase"/> pipeline.
/// </summary>
public sealed class MoonshotKimiChatModel: OpenAICompatibleChatModelBase
{
    /// <summary>Initializes a new instance of the <see cref="MoonshotKimiChatModel"/> class.</summary>
