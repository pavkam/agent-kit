...
/// <summary>Identifies the exact initialized JSON budget-ledger root expected by host bootstrap configuration.</summary>
/// <remarks>
...
/// serving another deployment's accounting as if it were this composition's capacity.
/// </remarks>
public readonly record struct JsonBudgetLedgerInstanceId
{
    ...
    public JsonBudgetLedgerInstanceId(Guid value)
    {
