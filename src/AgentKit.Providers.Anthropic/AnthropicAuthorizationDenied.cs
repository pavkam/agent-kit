...
/// </remarks>
public sealed record AnthropicAuthorizationDenied: AnthropicAuthorizationResult
{
    /// <summary>Initializes a new instance of the <see cref="AnthropicAuthorizationDenied"/> record.</summary>
    /// <param name="failure">
    /// The normalized failure, whose <see cref="ProviderFailure.Kind"/> is
    /// <see cref="ProviderFailureKind.Authentication"/>.
    /// </param>
    /// <exception cref="ArgumentNullException"><paramref name="failure"/> is null.</exception>
    public AnthropicAuthorizationDenied(ProviderFailure failure)
    {
