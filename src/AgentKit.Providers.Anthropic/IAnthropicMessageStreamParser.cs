...
/// <summary>
/// Parses a raw Anthropic Messages HTTP response body into the ordered
...
/// </remarks>
public interface IAnthropicMessageStreamParser
{
    /// <summary>
    ...
    /// delivering incremental events as each Anthropic streaming event
    /// arrives.
    /// </summary>
