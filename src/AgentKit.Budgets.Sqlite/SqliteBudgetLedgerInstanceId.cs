...
/// <summary>Identifies the exact initialized SQLite budget-ledger target expected by host bootstrap configuration.</summary>
public readonly record struct SqliteBudgetLedgerInstanceId
{
    ...
    public SqliteBudgetLedgerInstanceId(Guid value)
    {
