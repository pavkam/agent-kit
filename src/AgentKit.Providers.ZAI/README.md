# AgentKit.Providers.ZAI

Connect AgentKit conversational models to Z.ai through its OpenAI-compatible
chat surface.

Use this adapter when your application selects Z.ai. Configure the endpoint,
...
Start with `AddZAI`, `AddZAILlmModel` in
...
- [AgentKit.Providers.ZAI.Tests](../../tests/AgentKit.Providers.ZAI.Tests/README.md)
  — focused behavior and registration tests.
- [Component specification](../../docs/architecture/model-and-embedding-providers.md)
  — intended ownership and contracts.
- [Z.ai API reference](../../docs/providers/z-ai.md) — wire behavior and
