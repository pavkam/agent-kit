...
/// <summary>
/// The Groq conversational <see cref="ILlmModel"/>, built entirely
/// from the shared <see cref="OpenAICompatibleLlmModelBase"/> pipeline.
/// </summary>
public sealed class GroqLlmModel: OpenAICompatibleLlmModelBase
{
    /// <summary>Initializes a new instance of the <see cref="GroqLlmModel"/> class.</summary>
