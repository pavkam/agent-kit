...
/// <summary>Lexical normalizer that delegates validation to <see cref="NormalizedRelativePath"/>.</summary>
internal sealed class DefaultFilePathNormalizer: IFilePathNormalizer
{
    /// <inheritdoc/>
