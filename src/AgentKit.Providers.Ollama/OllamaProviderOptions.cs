...
/// <summary>
/// Configures the Ollama integration's endpoint and wire-behavior
/// defaults.
/// </summary>
/// <remarks>
...
/// <c>AddOllamaApiKeyCredential</c> or <c>AddOllamaOAuthCredential</c>, because
...
{
    /// <summary>Gets or sets the base address of the Ollama REST API.</summary>
    public Uri BaseAddress { get; set; } = OllamaProviderDefaults.DefaultBaseAddress;

    /// <summary>Gets or sets the chat completions operation path, relative to <see cref="BaseAddress"/>.</summary>
    public string ChatCompletionsPath { get; set; } = OllamaProviderDefaults.DefaultChatCompletionsPath;

    /// <summary>Gets or sets the embeddings operation path, relative to <see cref="BaseAddress"/>.</summary>
    public string EmbeddingsPath { get; set; } = OllamaProviderDefaults.DefaultEmbeddingsPath;
    ...
    /// <summary>
    /// Gets or sets whether a streaming request should ask Ollama to
