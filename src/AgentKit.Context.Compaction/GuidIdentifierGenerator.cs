...
/// <c>AddContextCompaction</c> for <see cref="CompactionManifestId"/> and
/// <see cref="SessionEntryId"/> generation. Applications and tests register
/// a deterministic <see cref="IIdentifierGenerator{TIdentifier}"/> in its
