...
/// <see cref="ICohereResponseParser"/> needs to translate one raw Cohere
/// v2 Chat HTTP response body into a <see cref="ModelResponseEvent"/>
/// sequence.
/// </summary>
/// <remarks>
...
/// </remarks>
public sealed record CohereResponseParseContext
{
    /// <summary>Initializes a new instance of the <see cref="CohereResponseParseContext"/> record.</summary>
    ...
    /// </param>
    public CohereResponseParseContext(
