...
| Composition and configuration | Verified: engine-level admission through `Agent.SendAsync` (session create/open with ownership checks, process-local per-session lanes applying `SessionBusyBehavior`, user-message append, keyed run compilation, observer wiring) and multi-agent hosting through `AgentKit.Simple.AddAgent`; remaining: queue-backed admission, run attachment/cancellation by `RunId`, durable lane acceptance, catalog publication/reload, readiness                                                                                                                                                                                                                                                                                                                                                                               |
