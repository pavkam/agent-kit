...
| `AgentDefinition.Tools`, `ToolChoice`; no `Toolsets`, no executor key                                                                                                                                                                                                                                                                                       | CONFIRMED                          | `AgentDefinition.cs:36-37,95-96,295-320`; mirrored in `AgentRunRequest.cs:263-269`, `ContextAssemblyRequest.cs:179`                                                                                                     |
| `ToolsetReference`, `ToolsetPublication`, `ToolDiscoveryRequest.Toolsets`                                                                                                                                                                                                                                                                                   | EXISTS (values)                    | `Abstractions/Tools/`                                                                                                                                                                                                   |
| `IToolExecutor`, `IToolScheduler`, `ToolBatch(Result)`, `IToolCallRecorder`, `IToolResultProjector`, `IToolEventSink`, `IToolResolver`, `IToolArgumentValidator`, `IToolExecutionPolicy(+Selector)`, `IToolResultNormalizer`, `ToolInvocationContext`, `ValidatedToolCall`, `PreparedToolCall`, `ResolvedToolCall`, `ToolRuntimeOptions`, `ToolRetryPolicy` | MISSING                            | –                                                                                                                                                                                                                       |
...
- Depends on: C3, C5a, C7a. Risk: CONTRACT-BREAK (`new AgentDefinition(` in 6
  test files, `AgentRunRequest.Tools`, `ContextAssemblyRequest.Tools`,
