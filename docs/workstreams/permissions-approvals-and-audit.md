...
| Item                                                                                                                                                                                                                                                                                                                                        | State                   | Evidence                                                                                                                                                                                                                        |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ISecurityPolicyCatalog`, `ISecurityPolicySelector`, `SecurityPolicySnapshotResult`                                                                                                                                                                                                                                                         | EXISTS-UNWIRED (WS3-C1) | contracts and 3-case result added under `Abstractions/Security/`; authority still compares the static `AgentPermissionOptions.PolicySnapshot` at `src/AgentKit.Permissions/SecurityAuthority.cs:183-191` (unwired until WS3-C4) |
...
| `ISecurityGrantIssuer`, `ISecurityDecisionStore`                                                                                                                                                                                                                                                                                            | EXISTS-UNWIRED (WS3-C1) | `Abstractions/Security/ISecurityGrantIssuer.cs`, `ISecurityDecisionStore.cs`; minting still inline at `SecurityAuthority.cs:303-354` (unwired until WS3-C6a)                                                                    |
...
| `ISecurityPolicy.EvaluateAsync(request, SecurityPolicyContext, ct)`                                                                          | `:247-253`                                   | SPEC; `SecurityPolicyContext` interim type added in WS3-C1, unwired until C3                                                                                                                                                                 |
