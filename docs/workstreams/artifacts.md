...
| Item                                                                                                                                                                                                                   | State                                              | Evidence                                                                                                               |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| two-phase coordinator                                                                                                                                                                                                  | EXISTS, single unkeyed store, `ISecurityAuthority` | `src/AgentKit.Artifacts/DefaultArtifactCoordinator.cs:25-47,79-93`; `AddAgentArtifacts(Action<AgentArtifactOptions>?)` |
...
7. `ArtifactProcessOutputSink` resolves the unkeyed coordinator; C4 binds it to
   one key.
