...
/// <summary>
/// End-to-end tests for the concrete <see cref="AzureOpenAIEmbeddingModel"/>,
...
/// </summary>
public sealed class AzureOpenAIEmbeddingModelEndToEndTests
{
    ...
    private static EmbeddingModelDescriptor CreateDescriptor() =>
        new(
            ...
            new DeploymentId("prod-embed"),
            AzureOpenAIProviderDefaults.DefaultEmbeddingCapabilities,
            AzureOpenAIProviderDefaults.DefaultEmbeddingLimits,
            pricing: null,
            ExtensionData.Empty);
    ...
    private static AzureOpenAIEmbeddingModel CreateModel(
