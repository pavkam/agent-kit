...
/// <summary>
/// End-to-end tests for <see cref="CohereEmbeddingModel"/>, exercising the
/// full pipeline (credential resolution, translation, transport, and
/// response parsing) against a stub HTTP handler serving fixture payloads.
/// No test in this class performs a real network call.
/// </summary>
public sealed class CohereEmbeddingModelEndToEndTests
{
    ...
    private static CohereEmbeddingModel CreateModel(
        ...
        new(
            ...
            new CohereEmbeddingRequestTranslator(),
            new CohereEmbeddingResponseParser(),
            credentials,
    ...
    public async Task GenerateAsync_WhenPurposeIsUnspecified_FailsWithInvalidRequestWithoutSendingHttpRequest()
    {
        ...
        var request = new EmbeddingModelRequest(
            new EmbeddingRequestContext(
                new EmbeddingRequestId(Guid.NewGuid()),
                descriptor,
                new EmbeddingRequest(
