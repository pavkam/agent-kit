...
/// <summary>
/// End-to-end tests for <see cref="CohereLlmModel"/>, exercising the full
/// pipeline (capability check, credential resolution, translation,
...
/// </summary>
public sealed class CohereLlmModelEndToEndTests
{
    ...
    private static CohereLlmModel CreateModel(
        HttpMessageHandler handler,
        IProviderCredentialSource credentials,
        ModelDescriptor? descriptor = null,
        TimeProvider? timeProvider = null,
        CohereProviderOptions? options = null) =>
        new(
            descriptor ?? TestModels.CommandAPlus,
            options ?? new CohereProviderOptions { BaseAddress = new Uri("https://api.cohere.test/") },
            new CohereRequestTranslator(),
            new CohereResponseParser(new SequentialToolCallIdGenerator()),
            credentials,
    ...
    public async Task ExecuteAsync_WhenUnauthenticated_ReturnsAuthenticationFailureWithStatusCodeAndSafeMessage()
    {
        ...
        var options = new CohereProviderOptions { BaseAddress = new Uri("https://api.cohere.test/"), PreferStreaming = false };
    ...
    public async Task ExecuteAsync_WhenModelDoesNotSupportRequestedTools_FailsWithoutSendingHttpRequest()
    {
        ...
        var model = CreateModel(
            handler,
            new StaticProviderCredentialSource(new ApiKeyProviderCredential("cohere-test-key")),
    ...
    public async Task ExecuteAsync_WhenProviderRequestOptionsCarryExtensionData_ForwardsThemInSentBody()
    {
        ...
        var providerOptions = new ProviderRequestOptions(
            new ExtensionData(ImmutableDictionary<string, ExtensionValue>.Empty.Add("safety_mode", safetyModeValue)));
