# AgentKit.Providers.Cohere.Tests

Focused tests for
[AgentKit.Providers.Cohere](../../src/AgentKit.Providers.Cohere/README.md).

**Component purpose:** connect AgentKit conversational models to Cohere through
v2 Chat.
...
```sh
dotnet test --project tests/AgentKit.Providers.Cohere.Tests/AgentKit.Providers.Cohere.Tests.csproj --configuration Release --timeout 300s
```
