...
/// <summary>
/// End-to-end tests for <see cref="GoogleGeminiEmbeddingModel"/>,
...
/// </summary>
public sealed class GoogleGeminiEmbeddingModelEndToEndTests
{
    ...
    private static GoogleGeminiEmbeddingModel CreateModel(
        ...
        new(
            ...
            new GoogleGeminiEmbeddingRequestTranslator(),
            new GoogleGeminiEmbeddingResponseParser(),
            credentials,
