...
/// <summary>
/// Verifies <see cref="AnthropicMessageStreamParser.ParseBufferedAsync"/>
/// against fixture non-streaming Anthropic Messages response bodies.
/// </summary>
public sealed class AnthropicMessageStreamParserBufferedTests
{
