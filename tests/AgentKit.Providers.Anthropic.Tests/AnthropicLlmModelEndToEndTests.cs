...
/// <summary>
/// End-to-end tests for <see cref="AnthropicLlmModel"/>, exercising the
...
/// </summary>
public sealed class AnthropicLlmModelEndToEndTests
{
    ...
    private static AnthropicLlmModel CreateModel(
        ...
        new(
            ...
            options ?? new AnthropicProviderOptions { BaseAddress = new Uri("https://api.anthropic.test/") },
            new AnthropicMessageTranslator(),
            new AnthropicMessageStreamParser(new SequentialToolCallIdGenerator()),
            credentials,
    ...
    public async Task ExecuteAsync_WhenModelDoesNotSupportRequestedTools_FailsWithoutSendingHttpRequest()
    {
        ...
        var model = CreateModel(
            handler,
            new StaticProviderCredentialSource(new ApiKeyProviderCredential("sk-ant-test")),
    ...
    public async Task ExecuteAsync_WhenProviderRequestOptionsCarryExtensionData_ForwardsThemInSentBody()
    {
        ...
        var providerOptions = new ProviderRequestOptions(
            new ExtensionData(ImmutableDictionary<string, ExtensionValue>.Empty.Add("metadata", userIdValue)));
