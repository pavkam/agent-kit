...
/// <summary>
/// End-to-end tests for the concrete <see cref="OpenAIEmbeddingModel"/>,
...
/// </summary>
public sealed class OpenAIEmbeddingModelEndToEndTests
{
    ...
    private static EmbeddingModelDescriptor CreateDescriptor() =>
        new(
            ...
            deploymentId: null,
            OpenAIProviderDefaults.DefaultEmbeddingCapabilities,
            OpenAIProviderDefaults.DefaultEmbeddingLimits,
            pricing: null,
            ExtensionData.Empty);
