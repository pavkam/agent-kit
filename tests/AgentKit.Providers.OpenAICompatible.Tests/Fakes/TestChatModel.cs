...
/// <summary>
/// The minimal concrete <see cref="OpenAICompatibleChatModelBase"/>
...
/// </summary>
internal sealed class TestChatModel: OpenAICompatibleChatModelBase
{
    /// <summary>Initializes a new instance of the <see cref="TestChatModel"/> class.</summary>
