...
/// <summary>Verifies collision-resistant approval-request identity creation.</summary>
public sealed class GuidApprovalRequestIdGeneratorTests
{
    [Fact]
    public void Create_WhenCalledRepeatedly_ReturnsDistinctNonEmptyIdentities()
    {
        var generator = new GuidApprovalRequestIdGenerator();
