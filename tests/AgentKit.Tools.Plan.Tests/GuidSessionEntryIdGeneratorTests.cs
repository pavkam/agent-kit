...
/// <summary>Verifies GuidSessionEntryIdGenerator behavior and contracts.</summary>
public sealed class GuidSessionEntryIdGeneratorTests
{
    [Fact]
    public void Create_WhenCalledTwice_ReturnsDistinctNonDefaultIdentities()
    {
        var generator = new GuidSessionEntryIdGenerator();
