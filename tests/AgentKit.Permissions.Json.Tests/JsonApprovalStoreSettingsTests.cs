...
/// <summary>Verifies JsonApprovalStoreSettings bound validation, defaults, and value semantics.</summary>
public sealed class JsonApprovalStoreSettingsTests
{
    ...
    {
        var exception = Should.Throw<ArgumentOutOfRangeException>(() => new JsonApprovalStoreSettings(
    ...
    public void Constructor_WhenEncodingIsNull_ThrowsArgumentNull()
    {
        var exception = Should.Throw<ArgumentNullException>(
            () => new JsonApprovalStoreSettings(1, 1, 1, null!));
    ...
    public void Constructor_WhenValid_RetainsEveryBound()
    {
        ...
        var settings = new JsonApprovalStoreSettings(10, 20, 30, encoding);
    ...
    {
        var original = JsonApprovalStoreSettings.CreateDefault();
