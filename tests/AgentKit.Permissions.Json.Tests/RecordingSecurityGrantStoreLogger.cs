...
/// <summary>Records formatted JSON grant-store events so tests can verify stable event identifiers and content safety.</summary>
internal sealed class RecordingSecurityGrantStoreLogger: ILogger<JsonSecurityGrantStore>
{
