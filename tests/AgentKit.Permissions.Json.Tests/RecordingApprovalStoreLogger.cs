...
/// <summary>Records formatted JSON approval-store events so tests can verify stable event identifiers and content safety.</summary>
internal sealed class RecordingApprovalStoreLogger: ILogger<JsonApprovalStore>
{
