...
/// <summary>
/// End-to-end tests for the concrete <see cref="GroqChatModel"/>, constructed
...
/// network call to Groq.
/// </summary>
public sealed class GroqChatModelEndToEndTests
{
    ...
    public async Task ExecuteAsync_WhenUsingApiKeyCredential_SendsBearerHeaderAndReturnsCompletedResponse()
    {
        ...
        var options = new GroqProviderOptions { PreferStreaming = false };
        var descriptor = CreateDescriptor();

        var model = new GroqChatModel(
            descriptor,
