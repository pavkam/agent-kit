...
/// <summary>Verifies CompactionStrategyRequest behavior and contracts.</summary>
public sealed class CompactionStrategyRequestTests
{
    [Fact]
    public void CompactionStrategyRequest_Equality_WhenSameValues_InstancesAreEqual() => StrategyRequest().ShouldBe(StrategyRequest());
