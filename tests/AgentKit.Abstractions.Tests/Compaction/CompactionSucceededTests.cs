...
/// <summary>Verifies CompactionSucceeded behavior and contracts.</summary>
public sealed class CompactionSucceededTests
{
    [Fact]
    public void CompactionSucceeded_Equality_WhenSameValues_InstancesAreEqual() => new CompactionSucceeded(Context(), Record()).ShouldBe(new CompactionSucceeded(Context(), Record()));
