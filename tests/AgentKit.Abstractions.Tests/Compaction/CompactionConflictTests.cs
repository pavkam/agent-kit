...
/// <summary>Verifies CompactionConflict behavior and contracts.</summary>
public sealed class CompactionConflictTests
{
    [Fact]
    ...
    {
        var original = new CompactionConflict(Context(), new SessionVersion(1), new SessionVersion(2), Manifest());
