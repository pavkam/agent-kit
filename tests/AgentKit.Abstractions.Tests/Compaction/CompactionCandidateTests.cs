...
/// <summary>Verifies CompactionCandidate behavior and contracts.</summary>
public sealed class CompactionCandidateTests
{
    [Fact]
    public void CompactionCandidate_Equality_WhenSameValues_InstancesAreEqual() => Candidate().ShouldBe(Candidate());
