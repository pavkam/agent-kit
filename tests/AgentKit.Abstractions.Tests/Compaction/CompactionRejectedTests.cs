...
/// <summary>Verifies CompactionRejected behavior and contracts.</summary>
public sealed class CompactionRejectedTests
{
    [Fact]
    public void CompactionRejected_Equality_WhenSameValues_InstancesAreEqual() => new CompactionRejected(Context(), Rejection()).ShouldBe(new CompactionRejected(Context(), Rejection()));
    ...
    {
        var original = new CompactionRejected(Context(), Rejection());
