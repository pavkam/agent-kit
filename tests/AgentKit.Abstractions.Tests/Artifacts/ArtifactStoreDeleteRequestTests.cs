...
/// <summary>Verifies ArtifactStoreDeleteRequest behavior and contracts.</summary>
public sealed class ArtifactStoreDeleteRequestTests
{
    ...
    public void Constructor_WhenCalledWithValidArguments_InitializesProperties()
    {
        ...
        var request = new ArtifactStoreDeleteRequest(reference, scope, identity, grant, key);
    ...
    {
        var identity = Identity();
        var exception = Should.Throw<ArgumentNullException>(() => new ArtifactStoreDeleteRequest(null!, Scope(), identity, Grant(identity), new IdempotencyKey("delete")));
    ...
    {
        var identity = Identity();
        var exception = Should.Throw<ArgumentNullException>(() => new ArtifactStoreDeleteRequest(Reference(), null!, identity, Grant(identity), new IdempotencyKey("delete")));
    ...
    {
        var identity = Identity();
        var exception = Should.Throw<ArgumentNullException>(() => new ArtifactStoreDeleteRequest(Reference(), Scope(), null!, Grant(identity), new IdempotencyKey("delete")));
    ...
    {
        var identity = Identity();
        var exception = Should.Throw<ArgumentNullException>(() => new ArtifactStoreDeleteRequest(Reference(), Scope(), identity, null!, new IdempotencyKey("delete")));
    ...
    {
        var identity = Identity();
        var exception = Should.Throw<ArgumentException>(() => new ArtifactStoreDeleteRequest(Reference(), Scope(), identity, Grant(identity), default));
    ...
    {
        var identity = Identity();
        var original = new ArtifactStoreDeleteRequest(Reference(), Scope(), identity, Grant(identity), new IdempotencyKey("delete"));
