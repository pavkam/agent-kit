...
public sealed class ArtifactFinalizeRequestTests
{
    ...
    public void Constructor_WhenCalledWithValidArguments_InitializesProperties()
    {
        ...
        var request = new ArtifactFinalizeRequest(PreparationId(), AgentId(), SessionId(), null, correlation, identity, key);
    ...
    {
        var exception = Should.Throw<ArgumentNullException>(() => new ArtifactFinalizeRequest(PreparationId(), AgentId(), SessionId(), null, null!, Identity(), new IdempotencyKey("finalize")));
    ...
    {
        var exception = Should.Throw<ArgumentException>(() => new ArtifactFinalizeRequest(PreparationId(), AgentId(), SessionId(), null, Correlation(), Identity(), default));
    ...
    {
        var original = new ArtifactFinalizeRequest(PreparationId(), AgentId(), SessionId(), null, Correlation(), Identity(), new IdempotencyKey("finalize"));
