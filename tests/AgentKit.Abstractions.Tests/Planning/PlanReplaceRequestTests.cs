...
/// <summary>Verifies PlanReplaceRequest behavior and contracts.</summary>
public sealed class PlanReplaceRequestTests
{
    [Fact]
    public void Constructor_WhenCalledWithValidArguments_InitializesProperties()
    {
        ...
        var items = Items();
        var grant = Grant();
        var request = new PlanReplaceRequest(context, profile, toolCallId, "Plan", items, new PlanRevision(1), grant);
        request.Context.ShouldBe(context);
        request.SessionProfile.ShouldBe(profile);
        request.ToolCallId.ShouldBe(toolCallId);
        request.Title.ShouldBe("Plan");
    ...
    [Fact]
    public void Constructor_WhenExpectedRevisionIsNull_InitializesNullRevision()
    {
        var request = new PlanReplaceRequest(Context(), TestSecurityEvidence.SessionProfile(), ToolCallId(), "Plan", Items(), null, Grant());
        request.ExpectedRevision.ShouldBeNull();
    }

    [Fact]
    public void Constructor_WhenContextIsNull_ThrowsExactParameter()
    {
        var exception = Should.Throw<ArgumentNullException>(() => new PlanReplaceRequest(null!, TestSecurityEvidence.SessionProfile(), ToolCallId(), "Plan", Items(), null, Grant()));
    ...
    {
        var exception = Should.Throw<ArgumentNullException>(() => new PlanReplaceRequest(Context(), null!, ToolCallId(), "Plan", Items(), null, Grant()));
    ...
    {
        var exception = Should.Throw<ArgumentException>(() => new PlanReplaceRequest(Context(), TestSecurityEvidence.SessionProfile(), ToolCallId(), " ", Items(), null, Grant()));
    ...
    {
        var exception = Should.Throw<ArgumentException>(() => new PlanReplaceRequest(Context(), TestSecurityEvidence.SessionProfile(), ToolCallId(), "Plan", [null!], null, Grant()));
        exception.ParamName.ShouldBe("items");
    }

    [Fact]
    public void Constructor_WhenItemsIsEmpty_ThrowsExactParameter()
    {
        var exception = Should.Throw<ArgumentException>(() => new PlanReplaceRequest(Context(), TestSecurityEvidence.SessionProfile(), ToolCallId(), "Plan", [], null, Grant()));
        exception.ParamName.ShouldBe("items");
    }
    ...
    public void Constructor_WhenItemsRepeatId_ThrowsExactParameter()
    {
        ...
        var exception = Should.Throw<ArgumentException>(() => new PlanReplaceRequest(Context(), TestSecurityEvidence.SessionProfile(), ToolCallId(), "Plan", items, null, Grant()));
        exception.ParamName.ShouldBe("items");
    }
    ...
    {
        var exception = Should.Throw<ArgumentNullException>(() => new PlanReplaceRequest(Context(), TestSecurityEvidence.SessionProfile(), ToolCallId(), "Plan", Items(), null, null!));
    ...
    {
        var original = new PlanReplaceRequest(Context(), TestSecurityEvidence.SessionProfile(), ToolCallId(), "Plan", Items(), new PlanRevision(1), Grant());
