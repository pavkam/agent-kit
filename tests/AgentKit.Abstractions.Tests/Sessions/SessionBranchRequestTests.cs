...
/// <summary>Verifies SessionBranchRequest behavior and contracts.</summary>
public sealed class SessionBranchRequestTests
{
    ...
    private static SessionBranchRequest BranchRequest() => new(OperationContext(), BranchId, new SessionSequence(1), new IdempotencyKey("key"));
}
