...
/// <summary>Verifies SessionEntry behavior and contracts.</summary>
public sealed class SessionEntryTests
{
    ...
    [Fact]
    public void SessionEntry_Equality_WhenSameValues_InstancesAreEqual() => MessageEntry().ShouldBe(MessageEntry());
