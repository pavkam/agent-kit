...
/// <summary>Verifies SessionAppendedEvent behavior and contracts.</summary>
public sealed class SessionAppendedEventTests
{
    ...
    [Fact]
    public void SessionAppendedEvent_Equality_WhenSameValues_InstancesAreEqual() => new SessionAppendedEvent(Address(), DateTimeOffset.UnixEpoch, BranchId, new SessionVersion(1), 1).ShouldBe(new SessionAppendedEvent(Address(), DateTimeOffset.UnixEpoch, BranchId, new SessionVersion(1), 1));
