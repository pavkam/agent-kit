...
/// <summary>Verifies BudgetLedgerAlreadySettled behavior and contracts.</summary>
public sealed class BudgetLedgerAlreadySettledTests
{
    [Fact]
    public void BudgetLedgerResultWrappers_WhenRequiredValueIsNull_ThrowArgumentNullException() => Should.Throw<ArgumentNullException>(() => new BudgetLedgerAlreadySettled(null!)).ParamName.ShouldBe("commit");
    ...
    {
        var original = new BudgetLedgerAlreadySettled(Commit(ReservationId()));
