...
/// <summary>Verifies BudgetLedgerReleased behavior and contracts.</summary>
public sealed class BudgetLedgerReleasedTests
{
    [Fact]
    public void BudgetLedgerResultWrappers_WhenRequiredValueIsNull_ThrowArgumentNullException() => Should.Throw<ArgumentNullException>(() => new BudgetLedgerReleased(null!)).ParamName.ShouldBe("reservation");
