...
/// <summary>Verifies BudgetLedgerReconciliationRetainedUnknown behavior and contracts.</summary>
public sealed class BudgetLedgerReconciliationRetainedUnknownTests
{
    [Fact]
    public void BudgetLedgerResultWrappers_WhenRequiredValueIsNull_ThrowArgumentNullException() => Should.Throw<ArgumentNullException>(() => new BudgetLedgerReconciliationRetainedUnknown(null!)).ParamName.ShouldBe("reservation");
    ...
    {
        var original = new BudgetLedgerReconciliationRetainedUnknown(new BudgetLedgerReservationReference(Scope(), ReservationId()));
