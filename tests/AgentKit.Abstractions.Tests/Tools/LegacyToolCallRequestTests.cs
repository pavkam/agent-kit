...
/// <summary>Verifies LegacyToolCallRequest behavior and contracts.</summary>
public sealed class LegacyToolCallRequestTests
{
    [Fact]
    public void ToolCallRequest_Constructor_WhenToolNull_ThrowsArgumentNullException()
    {
        var exception = Should.Throw<ArgumentNullException>(() => new LegacyToolCallRequest(null!, ExecutionContext(), default, DateTimeOffset.UnixEpoch));
    ...
    {
        var exception = Should.Throw<ArgumentNullException>(() => new LegacyToolCallRequest(new ToolReference(new ToolAlias("t"), null, null), null!, default, DateTimeOffset.UnixEpoch));
    ...
    public void ToolCallRequest_Constructor_WhenValid_RoundTripsProperties()
    {
        ...
        var request = new LegacyToolCallRequest(tool, context, arguments, DateTimeOffset.UnixEpoch);
    ...
    {
        var tool = new ToolReference(new ToolAlias("t"), null, null);
        var original = new LegacyToolCallRequest(tool, ExecutionContext(), default, DateTimeOffset.UnixEpoch);
