...
/// <summary>
/// Verifies that durable carriers retain one inseparable address and captured
...
public sealed class DurableOperationBindingTests
{
    ...
    public void Constructor_WhenAfterRunCoordinatesMatchWithNoTurn_AcceptsCausalRunWithoutClaimingActiveRun()
    {
        ...
        var context = Context(DurabilityTestData.Authorization(
            DurabilityTestData.AgentId,
            DurabilityTestData.SessionId,
            new AfterRunOperationCorrelation(DurabilityTestData.OperationId, DurabilityTestData.RunId)));
    ...
    public void ThrowIfInvalidDurableOperationBinding_WhenAgentDiffers_ThrowsExactExceptionWithInferredParameter()
    {
        var address = DurabilityTestData.Address();
        var context = Context(DurabilityTestData.Authorization(
            new AgentId(Guid.Parse("f1000000-0000-0000-0000-000000000010")),
            DurabilityTestData.SessionId,
            new InRunOperationCorrelation(DurabilityTestData.OperationId, DurabilityTestData.RunId, DurabilityTestData.TurnId)));

        var exception = Should.Throw<ArgumentException>(
            () => ArgumentException.ThrowIfInvalidDurableOperationBinding(address, context));
    ...
    public void ThrowIfInvalidDurableOperationBinding_WhenSessionIsAbsent_UsesExplicitParameter()
    {
        ...
        var exception = Should.Throw<ArgumentException>(
            () => ArgumentException.ThrowIfInvalidDurableOperationBinding(address, context, "binding"));
    ...
    {
        var addressException = Should.Throw<ArgumentNullException>(
            () => ArgumentException.ThrowIfInvalidDurableOperationBinding(null!, DurabilityTestData.Context()));
        var contextException = Should.Throw<ArgumentNullException>(
            () => ArgumentException.ThrowIfInvalidDurableOperationBinding(DurabilityTestData.Address(), null!));
    ...
    {
        var addressException = Should.Throw<ArgumentNullException>(
            () => new DurableOperationBinding(null!, DurabilityTestData.Context()));
        var contextException = Should.Throw<ArgumentNullException>(
            () => new DurableOperationBinding(DurabilityTestData.Address(), null!));
    ...
    {
        var exception = Should.Throw<ArgumentException>(() => new DurableCheckpoint(
            DurabilityTestData.CheckpointId,
            DurabilityTestData.Address(),
            Context(BindingMismatch.Run),
    ...
    public void CarrierBindingConstructorsAndCopies_WhenGivenExactBinding_PreserveItWithoutIndependentCoordinateMutation()
    {
        ...
        var descriptor = new RecoverableOperationDescriptor(
            binding,
            new DurableOperationName("operation"),
        ...
        var copiedResult = result with { State = DurableOperationState.Faulted };
    ...
    {
        var checkpointException = Should.Throw<ArgumentNullException>(() => new DurableCheckpoint(
            DurabilityTestData.CheckpointId,
            null!,
            DurableCheckpointKind.RunSettled,
            DurabilityTestData.Payload(),
            DurabilityTestData.Token,
            DurabilityTestData.Now));
        var resultException = Should.Throw<ArgumentNullException>(() => new DurableOperationResult(
            null!,
            DurableOperationState.Completed,
            SideEffectCertainty.DefinitelyPerformed,
            DurabilityTestData.Payload(),
            DurabilityTestData.Token,
            DurabilityTestData.Now));
        var evidenceException = Should.Throw<ArgumentNullException>(() => new RecoveryEvidence(
            null!,
            DurableOperationState.OutcomeReady,
            SideEffectCertainty.Unknown,
            startDefinitelyAbsent: false,
        ...
        foreach (var exception in new[] { checkpointException, resultException, evidenceException, descriptorException })
        {
    ...
    public void RecoveryEvidence_WhenCheckpointBindingHasDifferentAddress_RejectsEvidenceConstruction()
    {
        ...
        var checkpointBinding = new DurableOperationBinding(
            new DurableOperationAddress(
                new AgentId(Guid.Parse("f7000000-0000-0000-0000-000000000016")),
                DurabilityTestData.SessionId,
                DurabilityTestData.RunId,
                DurabilityTestData.OperationId,
                DurabilityTestData.TurnId),
            DurabilityTestData.Context(DurabilityTestData.Authorization(
                new AgentId(Guid.Parse("f7000000-0000-0000-0000-000000000016")),
                DurabilityTestData.SessionId,
                new InRunOperationCorrelation(DurabilityTestData.OperationId, DurabilityTestData.RunId, DurabilityTestData.TurnId))));
    ...
    public void RecoveryEvidence_WhenCheckpointBindingHasDifferentDurabilityContext_RejectsEvidenceConstruction()
    {
        ...
        var checkpointBinding = new DurableOperationBinding(
            ...
            new DurableExecutionContext(
                new DurabilityProfileKey("other-profile"),
    ...
    public void RecoveryEvidence_WhenCheckpointBindingHasDifferentTenantIdentity_RejectsConstructionAndCopyWithoutChangingOriginal()
    {
        ...
        var otherTenantAuthorization = DurabilityTestData.Authorization(
            DurabilityTestData.AgentId,
            DurabilityTestData.SessionId,
            new InRunOperationCorrelation(DurabilityTestData.OperationId, DurabilityTestData.RunId, DurabilityTestData.TurnId),
            TestExecutionIdentity.Create(new TenantId("other-tenant"), new PrincipalId("principal"), ExecutionSubjectKind.Human));
    ...
    {
        var binding = new DurableOperationBinding(DurabilityTestData.Address(), DurabilityTestData.Context());
        var reconstructedBinding = new DurableOperationBinding(
            new DurableOperationAddress(
                DurabilityTestData.AgentId,
                DurabilityTestData.SessionId,
                DurabilityTestData.RunId,
    ...
    public void ThrowIfRecoveryEvidenceCheckpointDoesNotMatchBinding_WhenBindingIsNull_ThrowsExactOwningParameter()
    {
        var exception = Should.Throw<ArgumentNullException>(() =>
            ArgumentException.ThrowIfRecoveryEvidenceCheckpointDoesNotMatchBinding(null!, Checkpoint(
                new DurableOperationBinding(DurabilityTestData.Address(), DurabilityTestData.Context()))));
    ...
    [Fact]
    public void ThrowIfRecoveryEvidenceCheckpointDoesNotMatchBinding_WhenCheckpointIsNull_DoesNotThrow()
    {
        Should.NotThrow(() => ArgumentException.ThrowIfRecoveryEvidenceCheckpointDoesNotMatchBinding(
            new DurableOperationBinding(DurabilityTestData.Address(), DurabilityTestData.Context()),
            null));
    }
    ...
    {
        var binding = new DurableOperationBinding(DurabilityTestData.Address(), DurabilityTestData.Context());
        var checkpoint = Checkpoint(new DurableOperationBinding(
            DurabilityTestData.Address(),
            new DurableExecutionContext(
                new DurabilityProfileKey("other-profile"),
        ...
        var explicitName = Should.Throw<ArgumentException>(
            () => ArgumentException.ThrowIfRecoveryEvidenceCheckpointDoesNotMatchBinding(binding, checkpoint, "checkpointArgument"));
    ...
    private static RecoveryEvidence Evidence(DurableOperationBinding binding, DurableCheckpoint? latestCheckpoint = null) => new(
        binding,
        DurableOperationState.OutcomeReady,
        SideEffectCertainty.Unknown,
        startDefinitelyAbsent: false,
    ...
    private static DurableCheckpoint Checkpoint(DurableOperationBinding binding) => new(
        DurabilityTestData.CheckpointId,
        binding,
        DurableCheckpointKind.RunSettled,
        DurabilityTestData.Payload(),
    ...
    {
        BindingMismatch.Operation => new DurableOperationAddress(
            DurabilityTestData.AgentId,
            DurabilityTestData.SessionId,
            DurabilityTestData.RunId,
            new OperationId(Guid.Parse("f2000000-0000-0000-0000-000000000011")),
            DurabilityTestData.TurnId),
    ...
    {
        BindingMismatch.Operation => Context(DurabilityTestData.Authorization(
            DurabilityTestData.AgentId,
            DurabilityTestData.SessionId,
            new InRunOperationCorrelation(DurabilityTestData.OperationId, DurabilityTestData.RunId, DurabilityTestData.TurnId))),
        BindingMismatch.Session => Context(DurabilityTestData.Authorization(
            DurabilityTestData.AgentId,
            new SessionId(Guid.Parse("f3000000-0000-0000-0000-000000000012")),
            new InRunOperationCorrelation(DurabilityTestData.OperationId, DurabilityTestData.RunId, DurabilityTestData.TurnId))),
        BindingMismatch.Run => Context(DurabilityTestData.Authorization(
            DurabilityTestData.AgentId,
            DurabilityTestData.SessionId,
            new InRunOperationCorrelation(
                DurabilityTestData.OperationId,
                new RunId(Guid.Parse("f4000000-0000-0000-0000-000000000013")),
                DurabilityTestData.TurnId))),
        BindingMismatch.Turn => Context(DurabilityTestData.Authorization(
            DurabilityTestData.AgentId,
            DurabilityTestData.SessionId,
            new InRunOperationCorrelation(
                DurabilityTestData.OperationId,
                DurabilityTestData.RunId,
                new TurnId(Guid.Parse("f5000000-0000-0000-0000-000000000014"))))),
        BindingMismatch.AfterRunRun => Context(DurabilityTestData.Authorization(
            DurabilityTestData.AgentId,
            DurabilityTestData.SessionId,
            new AfterRunOperationCorrelation(
                DurabilityTestData.OperationId,
                new RunId(Guid.Parse("f6000000-0000-0000-0000-000000000015"))))),
        BindingMismatch.AfterRunTurn => Context(DurabilityTestData.Authorization(
            DurabilityTestData.AgentId,
            DurabilityTestData.SessionId,
            new AfterRunOperationCorrelation(DurabilityTestData.OperationId, DurabilityTestData.RunId))),
        BindingMismatch.BeforeRun => Context(DurabilityTestData.Authorization(
            DurabilityTestData.AgentId,
            DurabilityTestData.SessionId,
            new BeforeRunOperationCorrelation(DurabilityTestData.OperationId, null))),
        _ => throw new ArgumentOutOfRangeException(nameof(mismatch)),
    };

    private static DurableExecutionContext Context(SecurityAuthorizationContext authorization) => new(
