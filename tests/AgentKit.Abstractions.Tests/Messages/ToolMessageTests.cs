...
/// <summary>Verifies ToolMessage behavior and contracts.</summary>
public sealed class ToolMessageTests
{
    ...
    [Fact]
    public void ToolMessage_Equality_WhenSameValues_InstancesAreEqual() => new ToolMessage(MessageId, AgentId, SessionId, null, BranchId, null, null, DateTimeOffset.UnixEpoch, MessageState.Complete, Parts(), ExtensionData.Empty).ShouldBe(new ToolMessage(MessageId, AgentId, SessionId, null, BranchId, null, null, DateTimeOffset.UnixEpoch, MessageState.Complete, Parts(), ExtensionData.Empty));
