...
/// <summary>
/// Verifies <see cref="AwsBedrockProviderDefaults.BuildConverseUri"/>,
/// <see cref="AwsBedrockProviderDefaults.BuildConverseStreamUri"/>, and the
/// shared provider identity/capability defaults.
/// </summary>
public sealed class AwsBedrockProviderDefaultsTests
{
    private static AwsBedrockProviderOptions CreateOptions() => new() { Region = "us-east-1" };
    ...
    public void BuildConverseUri_WhenModelIdIsAnArn_PreservesSlashesLiterally()
    {
        ...
        uri.ShouldBe(new Uri(
            ...
            "arn%3Aaws%3Abedrock%3Aus-east-1%3A123456789012%3Ainference-profile/us.anthropic.claude-3-5-sonnet-20240620-v1%3A0/converse"));
    }

    [Fact]
    public void BuildConverseUri_WhenDifferentRegion_UsesThatRegionalHost()
    {
        var options = new AwsBedrockProviderOptions { Region = "eu-west-1" };
    ...
    [Fact]
    public void ProviderId_IsStableAwsBedrockIdentity() =>
        AwsBedrockProviderDefaults.ProviderId.ShouldBe(new ProviderId("aws-bedrock"));

    [Fact]
    public void ApiFamily_IsStableConverseIdentity() =>
        AwsBedrockProviderDefaults.ApiFamily.ShouldBe(new ApiFamilyId("aws-bedrock-converse"));
