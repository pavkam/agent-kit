...
/// <summary>
/// End-to-end tests for the concrete <see cref="XAIChatModel"/>, constructed
...
/// network call to xAI.
/// </summary>
public sealed class XAIChatModelEndToEndTests
{
    ...
    public async Task ExecuteAsync_WhenUsingApiKeyCredential_SendsBearerHeaderAndReturnsCompletedResponse()
    {
        ...
        var options = new XAIProviderOptions { PreferStreaming = false };
        var descriptor = CreateDescriptor();

        var model = new XAIChatModel(
            descriptor,
