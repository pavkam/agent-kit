...
/// <summary>
/// End-to-end tests for the concrete <see cref="DeepSeekLlmModel"/>,
...
/// a real network call to DeepSeek.
/// </summary>
public sealed class DeepSeekLlmModelEndToEndTests
{
    ...
    public async Task ExecuteAsync_WhenUsingApiKeyCredential_SendsBearerHeaderAndReturnsCompletedResponse()
    {
        ...
        var options = new DeepSeekProviderOptions { PreferStreaming = false };
        var descriptor = CreateDescriptor();

        var model = new DeepSeekLlmModel(
            descriptor,
            ...
            new StaticApiKeyCredentialSource("ds-real-looking-key"),
