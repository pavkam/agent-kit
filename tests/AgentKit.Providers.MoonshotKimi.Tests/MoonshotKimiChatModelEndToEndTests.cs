...
/// <summary>
/// End-to-end tests for the concrete <see cref="MoonshotKimiChatModel"/>, constructed
...
/// network call to Moonshot Kimi.
/// </summary>
public sealed class MoonshotKimiChatModelEndToEndTests
{
    ...
    private static ModelDescriptor CreateDescriptor() =>
        new(
            ...
            new ModelId("kimi-k2-0711-preview"),
            deploymentId: null,
    ...
    public async Task ExecuteAsync_WhenUsingApiKeyCredential_SendsBearerHeaderAndReturnsCompletedResponse()
    {
        ...
        var options = new MoonshotKimiProviderOptions { PreferStreaming = false };
        var descriptor = CreateDescriptor();

        var model = new MoonshotKimiChatModel(
            descriptor,
