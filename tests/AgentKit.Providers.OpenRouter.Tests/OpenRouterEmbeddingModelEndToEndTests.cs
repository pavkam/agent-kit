...
/// <summary>
/// End-to-end tests for the concrete <see cref="OpenRouterEmbeddingModel"/>,
...
/// a real network call.
/// </summary>
public sealed class OpenRouterEmbeddingModelEndToEndTests
{
    ...
    private static EmbeddingModelDescriptor CreateDescriptor() =>
        new(
            ...
            new ModelId("openai/text-embedding-3-small"),
            deploymentId: null,
            OpenRouterProviderDefaults.DefaultEmbeddingCapabilities,
            OpenRouterProviderDefaults.DefaultEmbeddingLimits,
            pricing: null,
            ExtensionData.Empty);

    private static EmbeddingModelRequest CreateRequest(EmbeddingModelDescriptor descriptor, EmbeddingPurpose purpose = EmbeddingPurpose.Unspecified) =>
        new(
